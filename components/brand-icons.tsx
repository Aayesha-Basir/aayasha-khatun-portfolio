 ...
 * so these are kept here as small, accessible-by-default (aria-hidden)
 * components that accept the same className/size props as lucide icons.
 */
...
export function MailIcon(props: SVGProps<SVGSVGElement>) {
  return (
    <Base {...props} fill="none">
      ...
      <path d="m3.5 6.5 8.5 6 8.5-6" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
    </Base>
  )
}
